            ...
            <button
              ...
              className={`${
                ...
                formik.values.message == ""
                  ...
                  : ""
              } inline-flex mt-4 float-left text-white bg-black border-blue-700 focus:outline-blue-800 hover:bg-blue-700 uppercase whitespace-nowrap shadow-xl border text-sm rounded-full py-2.5 px-5 font-semibold tracking-widest transition-colors`}
            >
              Send Message
            </button>
          </form>
