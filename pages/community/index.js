    ...
    <RootLayout title="Community">
      <Container>
        <div className="py-24 text-center tracking-tight">
          ...
          <p className="text-gray-500">Learn how to grow your business with expert advice</p>
        </div>
...
function BlogPost() {
  return (
    <div className="w-80 h-96 rounded-2xl overflow-hidden relative">
       <img src="https://tailwindui.com/img/ecommerce-images/category-page-04-image-card-04.jpg" 
            className="w-full h-full object-cover" />
      <div className="p-6 absolute bottom-0 left-0 bg-gradient-to-b to-gray-800/60 from-transparent w-full h-full">
        <div className="flex flex-col items-start justify-end w-full h-full text-white font-semibold">
        <div className="flex items-center justify-start space-x-2">
          <p className="text-xs font-thin">
            Mar 20, 2020 • 
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 inline-block pb-1">
